import { FaChartBar, FaRobot } from "react-icons/fa";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-gray-400 mt-6 text-sm sm:text-lg max-w-xl mx-auto lg:mx-0">
                We build AI assistants, automation systems, and modern
                frontend websites — landing pages and CRM workflows that help businesses grow.
              </p>
  ...
  >
    ...
    >
      ...
      {/* Instagram */}
      <div className="flex items-center gap-3 relative z-10">
        <SiInstagram className="text-xl text-lime-400" />
        <span className="font-medium text-white">
          Instagram
        </span>
      </div>
      ...
      {/* React */}
      <div className="flex items-center gap-3 relative z-10">
        <SiReact className="text-xl text-lime-400" />
        <span className="font-medium text-white">
          React
        </span>
      </div>
      ...
      {/* Tailwind CSS */}
      <div className="flex items-center gap-3 relative z-10">
        <SiTailwindcss className="text-xl text-lime-400" />
        <span className="font-medium text-white">
          Tailwind CSS
        </span>
      </div>
